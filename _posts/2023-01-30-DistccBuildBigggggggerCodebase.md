...
```bash
771416  Compile     crypto_x509.cc                                      bdc[0]
770804  Compile     node_metadata.cc                                    bdc[1]
770756  Compile     node_contextify.cc                                  bdc[2]
770812  Compile     node_os.cc                                         dell[0]
770799  Compile     node_messaging.cc                                  dell[1]
771201  Compile     crypto_rsa.cc                                      dell[2]
771456  Compile     node_javascript.cc                                 dell[4]
770826  Compile     node_process_events.cc                             dell[5]
771287  Compile     crypto_dh.cc                                       dell[7]
770841  Preprocess                                                localhost[0]
770842  Preprocess                                                localhost[3]
770825  Compile     node_postmortem_metadata.cc                         n10[0]
771028  Compile     inspector_js_api.cc                                 n10[1]
770833  Compile     node_process_object.cc                              n10[2]
770806  Compile     node_options.cc                                     n10[3]
770740  Compile     node_builtins.cc                                    tx3[0]
770782  Compile     node_http_parser.cc                                 tx3[1]
770669  Compile     debug_utils.cc                                      tx3[3]
770717  Compile     module_wrap.cc                                     zzh1[0]
770778  Compile     node_file.cc                                       zzh1[1]
770789  Compile     node_i18n.cc                                       zzh1[2]
770788  Compile     node_http2.cc                                      zzh1[3]
770774  Compile     node_external_reference.cc                         zzh2[0]
770647  Compile     async_wrap.cc                                      zzh2[1]
771435  Compile     node_crypto.cc                                     zzh2[2]
770674  Compile     env.cc                                             zzh2[3
```
