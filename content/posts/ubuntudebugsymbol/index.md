---
title: "GDB 调试本地程序和库"
summary: "记录 Ubuntu 下获取源码和 debug symbol 的方法，包括 ddebs、debuginfod、Build ID 和源码路径匹配。"
description: "记录 Ubuntu 下获取源码和 debug symbol 的方法，包括 ddebs、debuginfod、Build ID 和源码路径匹配。"
date: 2023-07-07
draft: false
categories:
  - "dev-environment"
