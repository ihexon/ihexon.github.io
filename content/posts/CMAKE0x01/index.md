---
title: "CMakeLists.txt 入门模板"
summary: "整理一个简单 CMakeLists.txt 的基本套路：填写 project 信息、引用宏、定义 option、编写判断逻辑，并组织 add_executable 与 target_sources。"
description: "整理一个简单 CMakeLists.txt 的基本套路：填写 project 信息、引用宏、定义 option、编写判断逻辑，并组织 add_executable 与 target_sources。"
date: 2023-07-04
draft: false
categories:
  - "build-system"
