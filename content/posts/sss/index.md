---
title: "BetterProfiler 比赛文档"
summary: "BetterProfiler 是一个面向嵌入式 Linux 的进程动态跟踪器，可追踪进程与内核生命周期、文件 I/O、网络 I/O、内存和加密读写行为。"
description: "BetterProfiler 是一个面向嵌入式 Linux 的进程动态跟踪器，可追踪进程与内核生命周期、文件 I/O、网络 I/O、内存和加密读写行为。"
date: 2023-01-26
draft: false
categories:
  - "security"
