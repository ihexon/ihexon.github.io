---
title: "libc.so _start 调试记录"
summary: "记录在 BinaryHacking 示例程序的 _start 处下断点时，GDB 先进入 glibc 动态链接器 _dl_start 的原因。"
description: "记录在 BinaryHacking 示例程序的 _start 处下断点时，GDB 先进入 glibc 动态链接器 _dl_start 的原因。"
date: 2023-07-07
draft: false
categories:
  - "binary-analysis"
